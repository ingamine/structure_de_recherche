...
use GestionAdministrative\LgmBundle\Entity\Media;
use GestionAdministrative\LgmBundle\Form\MediaType;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $media = $em->getRepository('LgmBundle:Media')->findAll();
    ...
    {
        $medium = new Media();
        $form = $this->createForm('GestionAdministrative\LgmBundle\Form\MediaType', $medium);
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('GestionAdministrative\LgmBundle\Form\MediaType', $medium);
