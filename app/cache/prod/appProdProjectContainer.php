...
class appProdProjectContainer extends Container
{
    ...
    {
        $a = new \Gedmo\SoftDeleteable\SoftDeleteableListener();
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'lgmenimc', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->addDriver($b, 'GestionAdministrative\\UserBundle\\Entity');
        $c->addDriver($b, 'GestionAdministrative\\LgmBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('GedmoTranslatable' => 'Gedmo\\Translatable\\Entity', 'GedmoTranslator' => 'Gedmo\\Translator\\Entity', 'GedmoLoggable' => 'Gedmo\\Loggable\\Entity', 'GedmoTree' => 'Gedmo\\Tree\\Entity', 'UserBundle' => 'GestionAdministrative\\UserBundle\\Entity', 'LgmBundle' => 'GestionAdministrative\\LgmBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bdbbc89eb26e9379ce59f7882e5b207e823e644c831b86a1e88ad97aa4aece8f');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('console.command', array(0 => 'extension.listener', 1 => 'onConsoleCommand'), -10);
     ...
     * This method always returns the same instance of the service.
     *
     * @return \GestionAdministrative\LgmBundle\Listener\DoctrineExtensionListener A GestionAdministrative\LgmBundle\Listener\DoctrineExtensionListener instance
     */
    protected function getExtension_ListenerService()
    {
        $this->services['extension.listener'] = $instance = new \GestionAdministrative\LgmBundle\Listener\DoctrineExtensionListener();
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('GestionAdministrative\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('GestionAdministrative\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('GestionAdministrative\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('GestionAdministrative\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'GestionAdministrative\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GestionAdministrative\\UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'\\src\\GestionAdministrative\\LgmBundle/Resources/views'), 'Lgm');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserBundle' => 'GestionAdministrative\\UserBundle\\UserBundle',
                'LgmBundle' => 'GestionAdministrative\\LgmBundle\\LgmBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'lgmenimc',
            'database_user' => 'root',
            ...
            'fos_user.model.user.class' => 'GestionAdministrative\\UserBundle\\Entity\\User',
