 ...
 */
class Mastere extends \GestionAdministrative\LgmBundle\Entity\Mastere implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Mastere' . "\0" . 'id', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Mastere' . "\0" . 'title', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Mastere' . "\0" . 'firstDateRegistered', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Mastere' . "\0" . 'Etablissement', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Mastere' . "\0" . 'created', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Mastere' . "\0" . 'updated', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Mastere' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mastere $proxy) {
