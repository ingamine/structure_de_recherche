 ...
 */
class Habilitation extends \GestionAdministrative\LgmBundle\Entity\Habilitation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'id', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'title', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'firstDateRegistered', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'directeur', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'Etablissement', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'created', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'updated', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Habilitation' . "\0" . 'deletedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Habilitation $proxy) {
