 ...
 */
class Media extends \GestionAdministrative\LgmBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Media' . "\0" . 'fileName', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Media' . "\0" . 'path', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Media' . "\0" . 'User', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Media' . "\0" . 'created', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Media' . "\0" . 'updated', '' . "\0" . 'GestionAdministrative\\LgmBundle\\Entity\\Media' . "\0" . 'deletedAt');
        }
